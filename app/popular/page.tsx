    ...
    <div className="mx-auto max-w-7xl px-3 md:px-5 py-2 md:py-3 lg:py-4">
      <div className="mb-2 md:mb-3 lg:mb-4">
        ...
        <p className="text-stone mt-1 md:mt-1.5 max-w-2xl text-sm md:text-base">
          Notable articles and analysis from Addis Crown. Note: True popularity metrics will be implemented in the reader engagement phase.
        </p>
      </div>
      ...
      <div className="max-w-article space-y-2 md:space-y-3 lg:space-y-4">
        {posts.length > 0 ? (
          ...
          <div className="text-center py-3 md:py-4 lg:py-6">
            <p className="text-stone text-sm md:text-base">Notable articles will appear here as our content library grows.</p>
            <Link
              href="/"
